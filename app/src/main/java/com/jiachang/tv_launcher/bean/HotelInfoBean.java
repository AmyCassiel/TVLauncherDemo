...
public class HotelInfoBean {
    ...
    public static class HotelDbBean {
        ...
        private HotelPromoteBean hotelPromote;
        private String hotelUsers;
        private int status;
        ...
        public HotelPromoteBean getHotelPromote() {
            return hotelPromote;
        }

        public void setHotelPromote(HotelPromoteBean hotelPromote) {
            this.hotelPromote = hotelPromote;
        }
        ...
        public static class HotelPromoteBean {
            /**  "id":3,
             "hotelId":120,
             "mainImage":"http://cdn.jiachang8.com/FqkwF10EtRTeXZP9oEJBr5yLIx9G" */
            private int id;
            private int hotelId;
