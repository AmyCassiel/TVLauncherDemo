 ...
 * @description
 */
public class ServiceNeedTypeAdapter extends RecyclerView.Adapter<ServiceNeedTypeAdapter.ViewHolder> implements View.OnClickListener {

    private List<NeedServiceType> mServiceGoods;
    ...
    public ServiceNeedTypeAdapter(Context context, List<NeedServiceType> serviceTypeList) {
...
//        onDetachedFromRecyclerView(recyclerView);
    ...
    public void setDataList(List<NeedServiceType> mServiceGoods) {
        mServiceGoods.clear();
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        NeedServiceType serviceType = mServiceGoods.get(position);
        ...
        holder.serviceExplain.setText(serviceType.getExplain());
    }
    ...
    public interface onItemClickListener {
        void onItemClick(int position, View v, NeedServiceType serviceType);
