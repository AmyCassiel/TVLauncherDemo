 ...
 * @description
 */
public class SControlTypeAdapter1 extends RecyclerView.Adapter<SControlTypeAdapter1.ViewHolder>{
    private Context context;
    private List<Controltype1> mServiceGoods;
    ...
    public SControlTypeAdapter1(Context context, List<Controltype1> serviceTypeList){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Controltype1 serviceType = mServiceGoods.get(position);
    ...
    public void setDataList( List<Controltype1> serviceTypeList){
